...
class Dist(object):
    ...
    # def estimate_params(self, x, dist='gaussian'):
    #     """
    #     Estimates the parameters of a given distribution (default: Gaussian).
    #     :param x (ndarray): The data points from which to estimate the parameters.
    #     :param dist (str): The distribution to estimate the parameters of.
    #     :return params (dict): The estimated parameters of the given distribution.
    #     """
